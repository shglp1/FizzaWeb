...
export const CONFIG_FIELD_META: Record<string, ConfigFieldMeta> = {
  ...
  loyaltyRedemptionEnabled: {
    ...
    type: 'boolean',
    hint: 'When true, parents can redeem loyalty points at subscription checkout.',
    defaultValue: false,
    recommended: 'false',
  },
  loyaltyRedemptionPointsPerSar: {
    label: 'Points per SAR discount',
    type: 'number',
    hint: 'How many points equal SAR 1 off at checkout (e.g. 10 = 10 points → SAR 1).',
    defaultValue: 10,
    recommended: '10',
  },
  loyaltyRedemptionMaxPercentOfOrder: {
    label: 'Max loyalty discount (% of order)',
    type: 'number',
    hint: 'Maximum subscription discount from loyalty points as a percentage of subtotal.',
    defaultValue: 20,
    recommended: '20',
  },
  loyaltyMinimumPointsToRedeem: {
    ...
    type: 'number',
    hint: 'Minimum loyalty points required to redeem at checkout.',
    defaultValue: 100,
    recommended: '100',
  },
